export const SliderButtons = ({ fullView, number, length, classSlides }) => {
  return (
    <div
      className={
        fullView
          ? `buttons flex items-center justify-between mb-5 lg:mb-2 w-2/3 relative lg:left-5 z-10 duration-500 translate-y-[50px]  lg:max-w-[30%]`
          : `buttons flex items-center justify-between mb-2 lg:mb-5 w-2/3 relative lg:left-0 z-10 duration-500 translate-y-1/4  lg:max-w-[30%]`
      }
    >
